...
<body style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;" style="background-color: #f5f5dc; ">
    ...
    <form method="post">
        <input style="background-color: black;" type="radio" name="buscar" value="1" <?php if ($buscar == "1") echo "checked" ?>> idquadrado<br>
        <input style="background-color: black;" type="radio" name="buscar" value="2" <?php if ($buscar == "2") echo "checked" ?>> lado<br>
        <input style="background-color: black;" type="radio" name="buscar" value="3" <?php if ($buscar == "3") echo "checked" ?>> Cor<br>
            <h3>Procurar Quadrado:</h3>
        <input type="text" style="background-color: black; color: white; text-align:center;" style="width: 25vw;" name="procurar" idquadrado="procurar"  value="<?php echo $procurar;?>">
                <br><br>
        <button name="acao" idquadrado="acao" type="submit">Procurar</button>
        <br><br>
    </div>
    </form>
        <div class="">
